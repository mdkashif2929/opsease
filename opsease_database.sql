...
-- Grant permissions to opsease_user
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO opsease_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO opsease_user;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA public TO opsease_user;

-- Set default privileges for future objects
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON TABLES TO opsease_user;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON SEQUENCES TO opsease_user;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON FUNCTIONS TO opsease_user;
